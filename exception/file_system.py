...
class TaskSelectionError(Exception):
    """
    Исключение для обработки ошибок неверного выбора задачи.

    Параметры:
    ----------
    task : str
        Некорректно выбранная задача.

    Сообщение:
    Некорректный выбор задачи: '<task>'. Допустимые значения: 'сегментация' или 'классификация'.
    """
    def __init__(self, task):
        super().__init__(
            f"Некорректный выбор задачи: '{task}'. Допустимые значения: 'сегментация' или 'классификация'."
        )
